...
def _drummer_asset() -> BandModelAsset:
    ...
    segments = (
        *_snowman_body(prefix),
        ...
        OutlineSegment("drummer_left_stick", f"{prefix}_STICKS", (p(58, 110), p(28, 52)), False, stroke="#fff4c2", stroke_width=3.0),
        OutlineSegment("drummer_right_stick", f"{prefix}_STICKS", (p(362, 110), p(392, 52)), False, stroke="#fff4c2", stroke_width=3.0),
        ...
        OutlineSegment("drummer_tom_left", f"{prefix}_TOM", (p(150, 344), p(198, 330), p(224, 364), p(184, 392), p(140, 378)), True, stroke="#c8ffff", stroke_width=3.4),
        OutlineSegment("drummer_tom_right", f"{prefix}_TOM", (p(222, 344), p(270, 330), p(300, 364), p(258, 394), p(216, 378)), True, stroke="#c8ffff", stroke_width=3.4),
        ...
        OutlineSegment("drummer_cymbal_left", f"{prefix}_CYMBALS", (p(56, 240), p(128, 224), p(184, 238), p(126, 258)), True, stroke="#fff48f", stroke_width=3.4),
        OutlineSegment("drummer_cymbal_right", f"{prefix}_CYMBALS", (p(236, 238), p(306, 220), p(374, 240), p(304, 260)), True, stroke="#fff48f", stroke_width=3.4),
    )
    return BandModelAsset(
        asset_id=f"{prefix}_front_background",
