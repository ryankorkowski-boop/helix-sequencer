    ...
    variants.update(
        {
            ...
            "v29.1": replace(
                ...
                version="v29.1",
                family="v29",
                title="Helix Prime Legacy QM Timing",
                timing_mode="beat",
                density_scale=0.88,
                randomness_scale=0.01,
                sweep_hit_ms=108,
                audio_intelligence_toolset="legacy_qm_timing",
            ),
            "v29.2": replace(
                base,
                version="v29.2",
                family="v29",
                title="Helix Prime Legacy Stem Marks",
                placement_mode="showcase_stems",
                density_scale=0.92,
                bass_scale=1.34,
                melody_scale=1.10,
                audio_intelligence_toolset="legacy_stem_marks",
            ),
            "v29.3": replace(
                base,
                version="v29.3",
                family="v29",
                title="Helix Prime Legacy Multiband",
                timing_mode="mixed",
                density_scale=0.96,
                speed_scale=1.04,
                darkness_scale=1.16,
                audio_intelligence_toolset="legacy_multiband_mir",
            ),
            "v29.4": replace(
                base,
                version="v29.4",
                family="v29",
                title="Helix Prime Legacy Audio Routes",
                pool_mode="rotating",
                density_scale=1.00,
                speed_scale=1.06,
                bass_scale=1.26,
                sweep_hit_ms=94,
                audio_intelligence_toolset="legacy_audio_routes",
            ),
            "v29.5": replace(
                base,
                version="v29.5",
                family="v29",
                title="Helix Prime Legacy Matrix Plan",
                timing_mode="mixed",
                placement_mode="showcase_signature",
                density_scale=0.94,
                melody_scale=1.18,
                primary_categories=("matrix", "mega", "line", "arch", "talking_heads", "sphere"),
                audio_intelligence_toolset="legacy_matrix_plan",
            ),
            "v29.6": replace(
                base,
                version="v29.6",
                family="v29",
                title="Helix Prime Legacy Chronoflow",
                placement_mode="showcase_signature",
                density_scale=0.93,
                speed_scale=1.02,
                melody_scale=1.20,
                darkness_scale=1.18,
                audio_intelligence_toolset="legacy_chronoflow",
            ),
            "v29.7": replace(
                base,
                version="v29.7",
                family="v29",
                title="Helix Prime Legacy Snowman Band",
                placement_mode="showcase_stems",
                keyboard_overlay=False,
                density_scale=0.90,
                bass_scale=1.30,
                melody_scale=1.22,
                audio_intelligence_toolset="legacy_snowman_band",
            ),
            "v29.8": replace(
                base,
                version="v29.8",
                family="v29",
                title="Helix Prime Legacy hardKor",
                timing_mode="mixed",
                density_scale=0.98,
                speed_scale=1.03,
                bass_scale=1.36,
                darkness_scale=1.20,
                audio_intelligence_toolset="legacy_hardkor",
            ),
            "v29.9": replace(
                base,
                version="v29.9",
                family="v29",
                title="Helix Prime Legacy Birdsong",
                timing_mode="hook",
                density_scale=0.86,
                randomness_scale=0.04,
                melody_scale=1.24,
                darkness_scale=1.08,
                audio_intelligence_toolset="legacy_birdsong",
            ),
        }
    )
    return variants
