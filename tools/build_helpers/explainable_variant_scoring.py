...
class VariantScoreReport:
    ...
    showcase_score: float | None = None
    ...
    def as_dict(self) -> dict[str, object]:
        ...
        if self.showcase_score is not None:
...
def score_variant(
    ...
    showcase_score = None
    if "showcase_score" in raw_variant:
        showcase_score = _clamp01(_as_float(raw_variant.get("showcase_score")))
    ...
    if showcase_score is not None:
        raw_metrics["showcase_score"] = showcase_score
