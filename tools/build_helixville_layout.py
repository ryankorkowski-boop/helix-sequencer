...
def _classify_model(model: ET.Element) -> DistrictPlan:
...
def build_helixville_layout(source_layout: Path, output_dir: Path) -> dict[str, object]:
    ...
    for model in models:
        district = _classify_model(model)
...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest = build_helixville_layout(source_layout, output_dir)
