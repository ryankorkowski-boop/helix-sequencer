...
from tools.build_helpers.helixville3 import (  # noqa: E402
    DEFAULT_GP_LAYOUT,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Helixville3 (legacy GP 256 + aligned neighbors/common props).")
    ...
    parser.add_argument(
        ...
        help="Path to allmodels xlights_rgbeffects.xml used for legal in-workspace imports",
    )
    parser.add_argument("--output-dir", default=str(ROOT / "helixville3"), help="Output show folder path")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"Helixville3 layout created: {manifest['output_layout']}")
    print(f"GP models: {manifest['gp_model_count']}")
    print(f"Imported neighbor/common models: {manifest['neighbor_imported_count']}")
